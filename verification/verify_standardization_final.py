...
def run_verification(page):
    ...
    page.screenshot(path="verification/screenshots/main_page_no_btns_fixed.png")

    # Click profile card to redirect
    print("Clicking profile card...")
    # Using specific click to avoid interception
    ...
    page.screenshot(path="verification/screenshots/admin_panel_fixed.png")
