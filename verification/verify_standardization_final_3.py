...
def run_verification(page):
    ...
    header.screenshot(path="verification/screenshots/header_clean_v3.png")
    ...
    page.screenshot(path="verification/screenshots/admin_panel_v3.png")
