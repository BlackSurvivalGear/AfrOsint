...
overlay.innerHTML='<div style="background:rgba(6,16,24,0.98);border:1px solid #44ff88;border-radius:8px;max-width:600px;width:100%;max-height:80vh;overflow-y:auto;padding:20px;font-family:Share Tech Mono,monospace;color:#d7ffff;font-size:12px;line-height:1.6;position:relative"><button onclick="document.getElementById(\'aiDeepDiveOverlay\').remove()" style="position:absolute;top:10px;right:14px;background:none;border:none;color:#ff4444;font-size:18px;cursor:pointer">✕</button><div style="color:#44ff88;font-size:14px;letter-spacing:2px;margin-bottom:12px;text-shadow:0 0 8px #44ff8866">🔬 DEEP DIVE: '+esc(countryName)+'</div><div id="aiDeepDiveContent" style="color:#7fd6df">⟳ Generating comprehensive intelligence brief...</div></div>';
...
content=content.replace(/^## (.+)$/gm,'<div style="color:#44ff88;font-size:12px;letter-spacing:1px;margin-top:14px;margin-bottom:6px;padding-bottom:4px;border-bottom:1px solid #44ff8833">$1</div>');
