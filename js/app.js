...
w.innerHTML='<div style="display:flex;align-items:stretch;gap:0;width:100%"><input id="countryPanelApiKey" type="password" placeholder="Integrate your API key..." style="flex:1;min-width:0;padding:6px 8px;background:#081821;border:1px solid #44ff8833;border-right:none;color:#d7ffff;font-size:11px;border-radius:4px 0 0 4px;font-family:Share Tech Mono,monospace;box-sizing:border-box" /><button onclick="_cpApiKeySet()" style="padding:6px 14px;background:#0c2430;border:1px solid #44ff8866;color:#44ff88;font-size:11px;cursor:pointer;border-radius:0 4px 4px 0;font-family:Share Tech Mono,monospace;white-space:nowrap;text-shadow:0 0 6px #44ff8866;letter-spacing:1px">Enable AI</button></div>';
}
}
