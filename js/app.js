...
<div style='display:flex;gap:10px;flex-wrap:wrap'><button class='atw-small-button' onclick="showBugoutSlidePanel('${escapedName}','${iso}')" style='background:#0c2430;border-color:#ff8800;color:#ff8800;text-shadow:0 0 6px #ff880088'>✈️ TRAVEL</button><button class='atw-small-button' onclick="showFxPanel('${currTicker}','${escapedName}')" style='background:#0c2430;border-color:#ffcc00;color:#ffcc00;text-shadow:0 0 6px #ffcc0088'>💱 FX RATES</button><button class='atw-small-button' onclick="showLiveNewsPanel('${escapedName}')" style='background:#0c2430;border-color:#44ff88;color:#44ff88;text-shadow:0 0 6px #44ff8888'>📺 LIVE NEWS</button></div>
<div style='display:flex;flex-direction:column;align-items:flex-end;gap:6px;background:#081821;border:1px solid #00ffee22;border-radius:8px;padding:10px 12px'>
<div id='cpApiKeyWrap' style='display:flex;align-items:center;gap:4px'></div>
<div style='display:flex;gap:8px'><button class='atw-small-button' onclick="aiCountrySitrepMaster('${escapedName}');document.getElementById('africaTimePanel').classList.remove('open');africaTimePanelOpen=false" style='background:#0c2430;border-color:#ff4444;color:#ff4444;text-shadow:0 0 6px #ff444488;font-size:11px;padding:6px 12px'>📋 SitRep</button><button class='atw-small-button' onclick="aiStrategicRelocation('${escapedName}');document.getElementById('africaTimePanel').classList.remove('open');africaTimePanelOpen=false" style='background:#0c2430;border-color:#cc44ff;color:#cc44ff;text-shadow:0 0 6px #cc44ff88;font-size:11px;padding:6px 12px'>🏠 RELOCATE</button></div>
</div>
</div>
