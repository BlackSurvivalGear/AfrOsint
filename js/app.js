...
<div style='display:flex;justify-content:flex-end;margin-bottom:8px'><div id='cpApiKeyWrap' style='display:flex;align-items:center;gap:4px'></div></div>
<div style='display:flex;justify-content:center;gap:10px;margin-bottom:12px;flex-wrap:wrap'><button class='atw-small-button' onclick="showBugoutSlidePanel('${escapedName}','${iso}')" style='background:#0c2430;border-color:#ff8800;color:#ff8800;text-shadow:0 0 6px #ff880088'>✈️ TRAVEL</button><button class='atw-small-button' onclick="showFxPanel('${currTicker}','${escapedName}')" style='background:#0c2430;border-color:#ffcc00;color:#ffcc00;text-shadow:0 0 6px #ffcc0088'>💱 FX RATES</button><button class='atw-small-button' onclick="showLiveNewsPanel('${escapedName}')" style='background:#0c2430;border-color:#44ff88;color:#44ff88;text-shadow:0 0 6px #44ff8888'>📺 LIVE NEWS</button><button class='atw-small-button' onclick="aiCountrySitrepMaster('${escapedName}');document.getElementById('africaTimePanel').classList.remove('open');africaTimePanelOpen=false" style='background:#0c2430;border-color:#ff4444;color:#ff4444;text-shadow:0 0 6px #ff444488'>📋 SitRep</button><button class='atw-small-button' onclick="aiStrategicRelocation('${escapedName}');document.getElementById('africaTimePanel').classList.remove('open');africaTimePanelOpen=false" style='background:#0c2430;border-color:#cc44ff;color:#cc44ff;text-shadow:0 0 6px #cc44ff88'>🏠 STRATEGIC RELOCATION</button></div>
