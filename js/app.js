...
const featuredChannels = [['SABC News', 'https://www.youtube.com/embed?listType=playlist&list=UUXYQNWoGuH-3Pb3zdaGFEmw'], ['Newzroom Afrika', 'https://www.youtube.com/embed?listType=playlist&list=UUNOc6D_St272mk8d4IsxD8A']];
const africanChannels=[...featuredChannels, ['DW Africa','https://www.youtube.com/embed/W8nThq62Vb4'],['Africanews','https://www.youtube.com/embed/NQjabLGdP5g'],['Africa Now','https://www.youtube.com/embed/Mv14aabg4mA'],['Arise News','https://www.youtube.com/embed/TJ5V8KRSu9Y'],['News Central TV','https://www.youtube.com/embed/mmZ7-HsnCuM'],['Citizen TV Kenya','https://www.youtube.com/embed/Cy2Pc0X1P7w']];
...
function renderChannelsWall(){
var h='<div style="padding:10px">';
h+='<h2 style="color:#00ffee;font-family:Share Tech Mono,monospace;letter-spacing:4px;padding:10px 0;margin:0;text-align:center;font-size:18px;border-bottom:1px solid #00ffee33;margin-bottom:16px">FEATURED CHANNELS</h2>';
h+='<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:16px;margin-bottom:30px">';
featuredChannels.forEach(function(ch){ h+=_renderChannelCard(ch); });
h+='</div>';
h+='<h2 style="color:#00ffee;font-family:Share Tech Mono,monospace;letter-spacing:4px;padding:10px 0;margin:0;text-align:center;font-size:18px;border-bottom:1px solid #00ffee33;margin-bottom:16px">AFRICAN CHANNELS</h2>';
h+='<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:16px">';
africanChannels.forEach(function(ch){
if(featuredChannels.some(f=>f[1]===ch[1]))return;
h+=_renderChannelCard(ch);
});
h+='</div>';
return h+'</div>';
}
