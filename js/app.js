...
function renderHeadlineContent(){const frame=document.getElementById('headlinesFrame');const toggleHtml='<div style="display:flex;justify-content:center;gap:8px;margin-bottom:20px"><button id="hlAfricaBtn" onclick="headlineMode=\'africa\';setTickerMode(\'africa\');renderHeadlineContent()" style="padding:8px 24px;font-family:Share Tech Mono,monospace;font-size:14px;letter-spacing:2px;border:1px solid #00ffee44;border-radius:4px;cursor:pointer;transition:all 0.2s;'+(headlineMode==='africa'?'background:#00ffee;color:#061018;text-shadow:none;box-shadow:0 0 12px #00ffee66':'background:transparent;color:#00ffee;text-shadow:0 0 6px #00ffee88')+'">AFRICA</button><button id="hlGlobalBtn" onclick="headlineMode=\'global\';setTickerMode(\'global\');renderHeadlineContent()" style="padding:8px 24px;font-family:Share Tech Mono,monospace;font-size:14px;letter-spacing:2px;border:1px solid #00ffee44;border-radius:4px;cursor:pointer;transition:all 0.2s;'+(headlineMode==='global'?'background:#00ffee;color:#061018;text-shadow:none;box-shadow:0 0 12px #00ffee66':'background:transparent;color:#00ffee;text-shadow:0 0 6px #00ffee88')+'">GLOBAL</button><button id="hlChannelsBtn" onclick="headlineMode=\'channels\';renderHeadlineContent()" style="padding:8px 24px;font-family:Share Tech Mono,monospace;font-size:14px;letter-spacing:2px;border:1px solid #00ffee44;border-radius:4px;cursor:pointer;transition:all 0.2s;'+(headlineMode==='channels'?'background:#00ffee;color:#061018;text-shadow:none;box-shadow:0 0 12px #00ffee66':'background:transparent;color:#00ffee;text-shadow:0 0 6px #00ffee88')+'">CHANNELS</button></div>';if(headlineMode==='channels'){frame.innerHTML=toggleHtml+renderChannelsWall();return}frame.innerHTML=toggleHtml+'<div id="headlinesGrid" style="text-align:center;color:#00ffee;font-family:Share Tech Mono,monospace;padding:40px">Loading headlines...</div>';if(headlineMode==='africa'){fetchAfricaHeadlines()}else{fetchAllHeadlines()}}
function renderChannelsWall(){return '<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:16px;padding:10px"><div style="border:1px solid #00ffee44;border-radius:8px;overflow:hidden;background:#081821"><div style="padding:8px 12px;background:linear-gradient(90deg,#081821,#0c2a35);border-bottom:1px solid #00ffee33;display:flex;align-items:center;gap:8px"><span style="color:#ff4444;font-size:8px">&#9679;</span><span style="color:#00ffee;font-family:Share Tech Mono,monospace;font-size:11px;letter-spacing:2px">CHANNEL 1</span></div><iframe width="100%" height="280" src="https://www.youtube.com/embed?listType=playlist&list=UUNOc6D_St272mk8d4IsxD8A" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border:none"></iframe></div><div style="border:1px solid #00ffee44;border-radius:8px;overflow:hidden;background:#081821"><div style="padding:8px 12px;background:linear-gradient(90deg,#081821,#0c2a35);border-bottom:1px solid #00ffee33;display:flex;align-items:center;gap:8px"><span style="color:#ff4444;font-size:8px">&#9679;</span><span style="color:#00ffee;font-family:Share Tech Mono,monospace;font-size:11px;letter-spacing:2px">CHANNEL 2</span></div><div style="height:280px;display:flex;align-items:center;justify-content:center;color:#7fd6df;font-family:Share Tech Mono,monospace;font-size:12px">PLACEHOLDER — CHANNEL COMING SOON</div></div><div style="border:1px solid #00ffee44;border-radius:8px;overflow:hidden;background:#081821"><div style="padding:8px 12px;background:linear-gradient(90deg,#081821,#0c2a35);border-bottom:1px solid #00ffee33;display:flex;align-items:center;gap:8px"><span style="color:#ff4444;font-size:8px">&#9679;</span><span style="color:#00ffee;font-family:Share Tech Mono,monospace;font-size:11px;letter-spacing:2px">CHANNEL 3</span></div><div style="height:280px;display:flex;align-items:center;justify-content:center;color:#7fd6df;font-family:Share Tech Mono,monospace;font-size:12px">PLACEHOLDER — CHANNEL COMING SOON</div></div><div style="border:1px solid #00ffee44;border-radius:8px;overflow:hidden;background:#081821"><div style="padding:8px 12px;background:linear-gradient(90deg,#081821,#0c2a35);border-bottom:1px solid #00ffee33;display:flex;align-items:center;gap:8px"><span style="color:#ff4444;font-size:8px">&#9679;</span><span style="color:#00ffee;font-family:Share Tech Mono,monospace;font-size:11px;letter-spacing:2px">CHANNEL 4</span></div><div style="height:280px;display:flex;align-items:center;justify-content:center;color:#7fd6df;font-family:Share Tech Mono,monospace;font-size:12px">PLACEHOLDER — CHANNEL COMING SOON</div></div><div style="border:1px solid #00ffee44;border-radius:8px;overflow:hidden;background:#081821"><div style="padding:8px 12px;background:linear-gradient(90deg,#081821,#0c2a35);border-bottom:1px solid #00ffee33;display:flex;align-items:center;gap:8px"><span style="color:#ff4444;font-size:8px">&#9679;</span><span style="color:#00ffee;font-family:Share Tech Mono,monospace;font-size:11px;letter-spacing:2px">CHANNEL 5</span></div><div style="height:280px;display:flex;align-items:center;justify-content:center;color:#7fd6df;font-family:Share Tech Mono,monospace;font-size:12px">PLACEHOLDER — CHANNEL COMING SOON</div></div><div style="border:1px solid #00ffee44;border-radius:8px;overflow:hidden;background:#081821"><div style="padding:8px 12px;background:linear-gradient(90deg,#081821,#0c2a35);border-bottom:1px solid #00ffee33;display:flex;align-items:center;gap:8px"><span style="color:#ff4444;font-size:8px">&#9679;</span><span style="color:#00ffee;font-family:Share Tech Mono,monospace;font-size:11px;letter-spacing:2px">CHANNEL 6</span></div><div style="height:280px;display:flex;align-items:center;justify-content:center;color:#7fd6df;font-family:Share Tech Mono,monospace;font-size:12px">PLACEHOLDER — CHANNEL COMING SOON</div></div></div>'}
