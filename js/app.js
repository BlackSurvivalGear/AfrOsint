...
var h='<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:16px;padding:10px">';
africanChannels.forEach(function(ch){
h+='<div style="border:1px solid #00ffee44;border-radius:8px;overflow:hidden;background:#081821">'+
