...
var _osintAccounts=[
{handle:'AfricanManOrg',region:'afrosint',type:'osint'},
...
var _mapFeedTab='afrosint',_mapFeedAllItems=[];
...
if(tabAfrosint){tabAfrosint.addEventListener('click',function(e){e.stopPropagation();e.preventDefault();_switchMapFeedTab('afrosint')})}
...
if(_mapFeedTab==='afrosint')items=items.filter(function(t){return t._region==='afrosint'});
...
var regionBar='';
if(oActive){
var regions=['afrosint','global','africa','aes','iran'];
...
if(_liveFeedRegion==='afrosint')filtered=allTweets.filter(function(t){return t._region==='afrosint'});
